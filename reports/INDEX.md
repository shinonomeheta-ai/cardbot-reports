...
| 2026-09-05（追記 同日夜） | 巡回停止の原因究明と復帰（セッション ci） | 8回連続停止の原因は「同じ素性を生きた応募回が2つ持つ」形（198組）。孤児1,038件は別の地雷。案B #1314・案C #1315・保留の中身 #1316 をマージし巡回復帰（2回連続 success）／段1の4項目 | [2026-09-05-crawl-outage-stage1.md](https://github.com/shinonomeheta-ai/cardbot-reports/blob/main/reports/2026-09-05-crawl-outage-stage1.md) | 段1は設計どおり（③ 素通り0を確定）／ラチェットは基準を上げず赤のまま・#1318 マージ 5a159747／案イ-2＋案Eは1つの設計として次の区切り／identity_key_holds.json は案ロ（人の決着を書く台帳）の材料（2026-09-05） | 完了 |
