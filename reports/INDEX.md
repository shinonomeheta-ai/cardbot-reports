...
| 2026-09-05 | CI費用の削減 1 | 台帳の修正（#1289 マージ）／吸収の測り直し／U+007F の経路 | [2026-09-05-control-char.md](https://github.com/shinonomeheta-ai/cardbot-reports/blob/main/reports/2026-09-05-control-char.md) | 判断待ち（制御文字の関門と除去）。吸収は差し戻し後 +0 件と実測 | 確認中 |
