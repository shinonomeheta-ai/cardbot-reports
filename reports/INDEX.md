...
| 2026-09-04（追記 09-04×2） | 引きの別名対応・段1 | 店名の索引を1本にする（実施・PR #1270・store-name-b） | [2026-09-04-official-handle-index.md](https://github.com/shinonomeheta-ai/cardbot-reports/blob/main/reports/2026-09-04-official-handle-index.md) | 承認・マージ済（c1a4337c）。本体は #1269（store-name-a）が先に main へ入っていたため #1270 は「登録名の完全一致を先に見る」差分だけに縮小。セッション名の重複は本人が整理し a/b で確定。段2は store-name-a 担当 | 完了 |
