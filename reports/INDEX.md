...
| 2026-09-05 | CI費用の削減 1 | U+007F を止める／test_url_candidate の切り分け／案B の実装 | [2026-09-05-collapse-round-id.md](https://github.com/shinonomeheta-ai/cardbot-reports/blob/main/reports/2026-09-05-collapse-round-id.md) | #1293 マージ済み・#1294 はCI待ち。ページ台帳の20件は判断待ち | 確認中 |
