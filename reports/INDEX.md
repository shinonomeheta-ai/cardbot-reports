...
| 2026-09-05 | 引きの別名対応・案A(a)/案Bの絞り込み/(d) | 幽霊7件を統合＋売り方が違う相手は止めない＋誤登録4件の一覧（store-name-a） | [2026-09-05-merge-ghosts-and-misregistration.md](https://github.com/shinonomeheta-ai/cardbot-reports/blob/main/reports/2026-09-05-merge-ghosts-and-misregistration.md) | 判断待ち（PR #1287・(d)4件はci セッションと突き合わせ要） | 確認中 |
